...
{
    public class ProgramSubjectBusiness : IDisposable
    {
        /// <summary>
        /// Interfaz que operará sobre DAL
        /// </summary>
        private ProgramSubjectData _data;
        ...
        /// </summary>
        public ProgramSubjectBusiness()
        {
            this._data = new ProgramSubjectData();
        ...
        /// <returns></returns>
        public void Add(ProgramSubject element)
        {
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Update(ProgramSubject element)
        {
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Delete(ProgramSubject element)
        {
        ...
        public ProgramSubject Get(Guid Identifier)
        {
            ProgramSubject data = this._data.Get(Identifier);
            return data;
        }
        ...
        {
            List<ProgramSubject> data = this._data.GetList();
            return data;
        }
