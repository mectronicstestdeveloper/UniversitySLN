...
{
    public class RoomBusiness : IDisposable
    {
        /// <summary>
        ...
        public Room Get(Guid Identifier)
        {
            Room data = this._data.Get(Identifier);
            return data;
        }
        ...
        {
            List<Room> data = this._data.GetList();
            return data;
        }
