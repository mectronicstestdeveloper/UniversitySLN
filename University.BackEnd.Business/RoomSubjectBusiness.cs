...
{
    public class RoomSubjectBusiness : IDisposable
    {
        /// <summary>
        /// Interfaz que operará sobre DAL
        /// </summary>
        private RoomSubjectData _data;
        ...
        /// </summary>
        public RoomSubjectBusiness()
        {
            this._data = new RoomSubjectData();
        ...
        /// <returns></returns>
        public void Add(RoomSubject element)
        {
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Update(RoomSubject element)
        {
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Delete(RoomSubject element)
        {
        ...
        public RoomSubject Get(Guid Identifier)
        {
            RoomSubject data = this._data.Get(Identifier);
            return data;
        }
        ...
        {
            List<RoomSubject> data = this._data.GetList();
            return data;
        }
