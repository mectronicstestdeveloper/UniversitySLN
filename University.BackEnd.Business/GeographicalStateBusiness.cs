...
{
    public class GeographicalStateBusiness : IDisposable
    {
        /// <summary>
        /// Interfaz que operará sobre DAL
        /// </summary>
        private GeographicalStateData _data;
        ...
        /// </summary>
        public GeographicalStateBusiness()
        {
            this._data = new GeographicalStateData();
        ...
        /// <returns></returns>
        public void Add(GeographicalState element)
        {
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Update(GeographicalState element)
        {
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Delete(GeographicalState element)
        {
        ...
        public GeographicalState Get(Guid Identifier)
        {
            GeographicalState data = this._data.Get(Identifier);
            return data;
        }
        ...
        {
            List<GeographicalState> data = this._data.GetList();
            return data;
        }
