...
{
    public class NotesBusiness : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        public NotesBusiness()
        {
            this._data = new NotesData();
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Update(Notes element)
        {
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Delete(Notes element)
        {
        ...
        public Notes Get(Guid Identifier)
        {
            Notes data = this._data.Get(Identifier);
            return data;
        }
        ...
        {
            List<Notes> data = this._data.GetList();
            return data;
        }
