...
{
    public class PersonTypeBusiness : IDisposable
    {
        /// <summary>
        /// Interfaz que operará sobre DAL
        /// </summary>
        private PersonTypeData _data;
        ...
        /// <returns></returns>
        public void Add(PersonType element)
        {
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Update(PersonType element)
        {
        ...
        /// <param name="element">Elemento de la entidad</param>
        /// <returns></returns>
        public void Delete(PersonType element)
        {
        ...
        public PersonType Get(Guid Identifier)
        {
            PersonType data = this._data.Get(Identifier);
            return data;
        }
        ...
        {
            List<PersonType> data = this._data.GetList();
            return data;
        }
