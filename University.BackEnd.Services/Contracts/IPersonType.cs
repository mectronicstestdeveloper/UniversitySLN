...
namespace University.BackEnd.Services.Contracts
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IPersonType : IDisposable
    {
        /// <summary>
        ...
        /// <returns></returns>
        [OperationContract]
        Task Delete(PersonType element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task Update(PersonType element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task<PersonType> Get(Guid identifer);
