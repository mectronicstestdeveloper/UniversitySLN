...
namespace University.BackEnd.Services.Contracts
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IProgramSubjectPerson : IDisposable
    {
        /// <summary>
        ...
        [OperationContract]
        Task Add(ProgramSubjectPerson element);
        ...
        /// <returns></returns>
        [OperationContract]
        Task Delete(ProgramSubjectPerson element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task Update(ProgramSubjectPerson element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task<ProgramSubjectPerson> Get(Guid identifer);
        ...
        /// <returns></returns>
        [OperationContract]
        Task<List<ProgramSubjectPerson>> GetList();
    }
}