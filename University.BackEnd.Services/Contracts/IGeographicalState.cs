...
namespace University.BackEnd.Services.Contracts
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IGeographicalState : IDisposable
    {
        /// <summary>
        ...
        [OperationContract]
        Task Add(GeographicalState element);
        ...
        /// <returns></returns>
        [OperationContract]
        Task Delete(GeographicalState element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task Update(GeographicalState element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task<GeographicalState> Get(Guid identifer);
        ...
        /// <returns></returns>
        [OperationContract]
        Task<List<GeographicalState>> GetList();
    }
}