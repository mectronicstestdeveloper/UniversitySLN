...
namespace University.BackEnd.Services.Contracts
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IRoomSubject : IDisposable
    {
        /// <summary>
        ...
        /// <returns></returns>
        [OperationContract]
        Task Delete(RoomSubject element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task Update(RoomSubject element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task<RoomSubject> Get(Guid identifer);
