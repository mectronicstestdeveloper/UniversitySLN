...
namespace University.BackEnd.Services.Contracts
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IProgramSubject : IDisposable
    {
        /// <summary>
        ...
        [OperationContract]
        Task Add(ProgramSubject element);
        ...
        /// <returns></returns>
        [OperationContract]
        Task Delete(ProgramSubject element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task Update(ProgramSubject element);
        ...
        /// <returns>Objeto de dominio</returns>
        [OperationContract]
        Task<ProgramSubject> Get(Guid identifer);
        ...
        /// <returns></returns>
        [OperationContract]
        Task<List<ProgramSubject>> GetList();
    }
}