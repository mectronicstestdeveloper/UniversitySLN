...
namespace University.BackEnd.Services.Services
{
    ...
    public class RoomServices : IRoom
    {
        ...
        /// </summary>
        public RoomServices() => this._business = new RoomBusiness();

        /// <summary>
        /// Clase que opera como capa de negocio
        /// </summary>
        public RoomBusiness _business;
        ...
        /// <returns></returns>
        public async Task Add(Room element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Delete(Room element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Update(Room element)
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<Room> Get(Guid identifer)
        {
            try
            {
        ...
        public async Task<List<Room>> GetList()
        {
            try
            {
                return await Task.Run<List<Room>>(() =>
                {
