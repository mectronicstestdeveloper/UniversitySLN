...
namespace University.BackEnd.Services.Services
{
    ...
    public class SubjectServices : ISubject
    {
        ...
        /// </summary>
        public SubjectServices() => this._business = new SubjectBusiness();

        /// <summary>
        /// Clase que opera como capa de negocio
        /// </summary>
        public SubjectBusiness _business;
        ...
        /// <returns></returns>
        public async Task Add(Subject element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Delete(Subject element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Update(Subject element)
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<Subject> Get(Guid identifer)
        {
            try
            {
                return await Task.Run<Subject>(() =>
                {
        ...
        public async Task<List<Subject>> GetList()
        {
            try
            {
                return await Task.Run<List<Subject>>(() =>
                {
