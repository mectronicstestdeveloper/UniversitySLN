...
namespace University.BackEnd.Services.Services
{
    ...
    /// </summary>
    public class PersonTypeServices : IPersonType
    {
        /// <summary>
        /// Constructor de la clase que instancia la capa de negocio
        /// </summary>
        public PersonTypeServices() => this._business = new PersonTypeBusiness();

        /// <summary>
        /// Clase que opera como capa de negocio
        /// </summary>
        public PersonTypeBusiness _business;
        ...
        /// <returns></returns>
        public async Task Add(PersonType element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Delete(PersonType element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Update(PersonType element)
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<PersonType> Get(Guid identifer)
        {
            try
            {
                return await Task.Run<PersonType>(() =>
                {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<List<PersonType>> GetList()
        {
            try
            {
                return await Task.Run<List<PersonType>>(() =>
                {
