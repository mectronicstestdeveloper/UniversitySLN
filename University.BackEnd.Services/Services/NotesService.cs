...
namespace University.BackEnd.Services.Services
{
    ...
    public class NotesServices : INotes
    {
        ...
        /// </summary>
        public NotesServices() => this._business = new NotesBusiness();

        /// <summary>
        /// Clase que opera como capa de negocio
        /// </summary>
        public NotesBusiness _business;
        ...
        /// <returns></returns>
        public async Task Add(Notes element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Delete(Notes element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Update(Notes element)
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<Notes> Get(Guid identifer)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<List<Notes>> GetList()
        {
            try
            {
                return await Task.Run<List<Notes>>(() =>
                {
