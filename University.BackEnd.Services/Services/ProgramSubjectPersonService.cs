...
namespace University.BackEnd.Services.Services
{
    ...
    /// </summary>
    public class ProgramSubjectPersonServices : IProgramSubjectPerson
    {
        /// <summary>
        /// Constructor de la clase que instancia la capa de negocio
        /// </summary>
        public ProgramSubjectPersonServices() => this._business = new ProgramSubjectPersonBusiness();

        /// <summary>
        /// Clase que opera como capa de negocio
        /// </summary>
        public ProgramSubjectPersonBusiness _business;
        ...
        /// <returns></returns>
        public async Task Add(ProgramSubjectPerson element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Delete(ProgramSubjectPerson element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Update(ProgramSubjectPerson element)
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<ProgramSubjectPerson> Get(Guid identifer)
        {
            try
            {
                return await Task.Run<ProgramSubjectPerson>(() =>
                {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<List<ProgramSubjectPerson>> GetList()
        {
            try
            {
                return await Task.Run<List<ProgramSubjectPerson>>(() =>
                {
