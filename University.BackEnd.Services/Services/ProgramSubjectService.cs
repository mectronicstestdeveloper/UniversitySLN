...
namespace University.BackEnd.Services.Services
{
    ...
    /// </summary>
    public class ProgramSubjectServices : IProgramSubject
    {
        /// <summary>
        /// Constructor de la clase que instancia la capa de negocio
        /// </summary>
        public ProgramSubjectServices() => this._business = new ProgramSubjectBusiness();

        /// <summary>
        /// Clase que opera como capa de negocio
        /// </summary>
        public ProgramSubjectBusiness _business;
        ...
        /// <returns></returns>
        public async Task Add(ProgramSubject element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Delete(ProgramSubject element)
        {
            try
            {
        ...
        /// <param name="element">Entidad</param>
        /// <returns></returns>
        public async Task Update(ProgramSubject element)
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<ProgramSubject> Get(Guid identifer)
        {
            try
            {
                return await Task.Run<ProgramSubject>(() =>
                {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<List<ProgramSubject>> GetList()
        {
            try
            {
                return await Task.Run<List<ProgramSubject>>(() =>
                {
